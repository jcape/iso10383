...
| Crate | Version | Usage |
| ----- | ------- | ----- |
| [`types`][types-link] | [![Crate][types-crate-image]][types-crate-link] | Core Types |
| [`static`][static-link] | [![Crate][static-crate-image]][static-crate-link] | Static Data |
| [`parser`][parser-link] | [![Crate][parser-crate-image]][parser-crate-link] | `ISO10383_MIC.XML` parser |
| [`macros`][macros-link] | [![Crate][macros-crate-image]][macros-crate-link] | Static Generator |

[//]: # (badges)

[types-link]: https://github.com/jcape/iso10383/tree/main/types
[static-link]: https://github.com/jcape/iso10383/tree/main/static
...
[conduct-image]: https://img.shields.io/badge/CoC-CC%203.0-4baaaa.svg?style=flat-square
