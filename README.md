...
| Crate | Usage |
| ----- | ----- |
| [`types`][types-link] | Core MIC types |
| [`static`][static-link] | Constant data for use in applications which handle MICs |
| [`parser`][parser-link] | A library for parsing the `ISO10383_MIC.XML` files |
| [`macros`][macros-link] | A proc-macro crate which generates constant data and enumerations |
